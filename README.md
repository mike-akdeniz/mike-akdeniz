...
### Load-Bearing —  a twenty-two chapter book about which software principles hold, and where they stop
...
91,000 words, CC BY 4.0 — **[read it](https://github.com/mike-akdeniz/load-bearing)**.
...
### FlowCore — a workflow library for Go
...
My production backend work has been C# and .NET. FlowCore is where I've been building in Go in earnest: a real schema, migrations, and a test suite that runs against Postgres 13 and 17, with the 38 design decisions behind it written down as they were made — **[FlowCore](https://github.com/mike-akdeniz/flowcore)**.
